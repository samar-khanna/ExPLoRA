...
#SBATCH --account=TODO
#SBATCH -J explora_knn                       # Job name
#SBATCH -o outputs/explora_knn%j.out         # output file (%j expands to jobID)
...
base_experiment_dir="${base_dir}/explora_knn"
...
# ============ Run ============
export PYTHONPATH=.
WANDB__SERVICE_WAIT=300 torchrun --nproc_per_node=$num_gpus --master_port=40001 -m linprobe.knn \
    --wandb=explora_knn \
    --wandb_entity=TODO \
