...
from .eval_metrics import AccuracyAveraging, build_topk_accuracy_metric
from .eval_setup import setup_and_build_model, get_args_parser as get_setup_args_parser
from .eval_helpers import ModelWithNormalize, evaluate, extract_features
...
def get_args_parser(
    ...
    parser.add_argument("--wandb", type=str, default=None, help="Wandb project name, eg: explora_knn")
...
def eval_knn_with_model(
    ...
    eval_transform = transform or get_transform(val_dataset_str, is_train=False)
